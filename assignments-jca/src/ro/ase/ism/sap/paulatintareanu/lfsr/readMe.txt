...
Test them in main with a sequence of 20 bytes and 50 bytes and print them in hex on the screen (if you see patterns or all bits 1 or 0 .........it could mean something is not right).
